...
final class HomeAPIPreview: HomeAPI {
    ...
    func getChallenges() async throws -> [TodayChallenge] {
        return [TodayChallenge(id: 0, imageUrl: "", title: "어제보다 5분 더 뛰기", estimatedMinute: 5, isSelected: false), TodayChallenge(id: 1, imageUrl: "", title: "어제보다 5분 더 뛰기", estimatedMinute: 5, isSelected: false)]
    }
    func getMonthlySummary() async throws -> MonthlySummaryResponseModel {
