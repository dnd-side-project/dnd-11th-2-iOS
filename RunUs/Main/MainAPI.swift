...
final class MainAPIPreview: MainAPI {
    func getChallenges() async throws -> [TodayChallenge] {
        return [TodayChallenge(id: 0, title: "어제보다 5분 더 뛰기", expectedTime: "5분", icon: "", type: "time", goalDistance: nil, goalTime: 5), TodayChallenge(id: 1, title: "어제보다 5분 더 뛰기", expectedTime: "5분", icon: "", type: "time", goalDistance: nil, goalTime: 5)]
    }
    func getWeathers(weatherParameters: WeatherParametersModel) async throws -> WeatherResponseModel {
